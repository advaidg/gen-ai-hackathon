...
public class UserControllerTest {
    ...
    // Additional test for potential XSS vulnerability in greeting()
    @Test
    public void testGreetingWithXSSInput() {
        ...
        assertEquals(expectedGreeting, result); // This is expected as the method doesn't sanitize input
        // To mitigate XSS vulnerability, input sanitization should be implemented
    }
}
